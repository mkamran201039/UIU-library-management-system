        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand">
                    ...
                    <img height=120 src="assets/img/logo2.png" />
                </a>
                           ...
                           <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="issue-book.php">Issue New Book</a></li>
                                     ...
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="myindex.php">Home Delivery Request</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="book_requst.php">New Book Request</a></li>
                                </ul>
                            </li>
