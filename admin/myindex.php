...
echo "<h4 >Home Delivery Book Request List  </h4>". "<br>";
...
else
{
  // echo "<h4 >Database successfully connected  vai</h4>". "<br>". "<br>";
   ...
   {
   echo "<h5>Request ID: ". $info["id"] ."<br> "  ."Book Title/ ISBN : ". $info["title"] ."<br>";
   echo "<h5>Mobile: ". $info["mobile"] ."<br> " ;
   echo "<h5>Address: ". $info["address"] ."<br><br> <br><br><hr>" ;
